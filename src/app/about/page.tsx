...
export const metadata: Metadata = {
  title: "About",
  description: "Maximilian Musial — cybersecurity student, pentesting enthusiast, Division 2 student athlete at SCSU.",
};
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
          <div style={{ border:"1px solid #30363D", borderRadius:8, background:"#161B22", padding:20 }}>
            ...
            {[
              ...
              [Users,"Athlete","Division 2 Student Athlete — SCSU Track & Field"],
